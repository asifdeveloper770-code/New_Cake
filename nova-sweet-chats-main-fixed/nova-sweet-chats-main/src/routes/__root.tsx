...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "N.Y Nova Cake Studio — Custom Cakes in Miami Beach" },
      {
        name: "description",
        content:
          "Boutique custom celebration and birthday cakes handcrafted in Miami Beach. Order easily via WhatsApp.",
      },
      { name: "author", content: "N.Y Nova Cake Studio" },
      { property: "og:site_name", content: "N.Y Nova Cake Studio" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Boutique custom celebration cakes handcrafted in Miami Beach, Florida.",
          telephone: "+1-305-540-7329",
